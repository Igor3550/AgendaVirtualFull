...
export const ScheduleListComponent = ({ schedules, refetch }) => {
  ...
  return (
    <Container>
      <TodaySchedulesArea>
        <Label>Agendamentos para hoje</Label>
      ...
      <PastSchedulesArea>
        <Label>Agendamentos atrasados não finalizados!</Label>

        {orderedSchedules.afterSchedules ?
          orderedSchedules.afterSchedules.map(schedule => <ScheduleComponent schedule={schedule} refetch={refetch} />)
        :<></>
        }
...
const PastSchedulesArea = styled.span`
